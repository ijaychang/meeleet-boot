package com.meeleet.boot.shared.file.service.impl;
...
import com.meeleet.boot.shared.file.service.FileService;
import com.meeleet.boot.system.model.dto.FileInfo;
import io.minio.*;
...
public class MinioFileService implements FileService {
     ...
     *
     * @param filePath 文件路径
     *                 https://oss.meeleet.tech/default/20221120/test.jpg
     * @return
     */
    @Override
    public boolean deleteFile(String filePath) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(customDomain)) {
                // https://oss.meeleet.tech/default/20221120/test.jpg → 20221120/websocket.jpg
