package com.meeleet.boot.core.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.meeleet.boot.common.annotation.Log)")
    public void logPointcut() {
    }

    @Around("logPointcut() && @annotation(logAnnotation)")
    public Object logExecutionTime(ProceedingJoinPoint joinPoint, com.meeleet.boot.common.annotation.Log logAnnotation) throws Throwable {
